...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.ApiCompanyList"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.ApiCompanyDetail"
                                        }
                                    }
                                }
                            ]
        ...
        "/company-visual-configs": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dados da Configuração Visual",
                        "name": "config",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreateCompanyVisualConfigRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.ApiCompanyVisualConfigDetail"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateCompanyVisualConfigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/company-visual-configs/{id}/logo": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Arquivo do logo (PNG, JPEG ou SVG)",
                        "name": "logo",
                        "in": "formData",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "domain.ApiCompanyVisualConfigDetail": {
            "type": "object",
            "properties": {
                "accent_color": {
                    "type": "string"
        ...
        "domain.CreateCompanyVisualConfigRequest": {
            "type": "object",
            "required": [
                "company_id",
                "primary_color"
        ...
        "domain.UpdateCompanyVisualConfigRequest": {
            "type": "object",
            "required": [
                "primary_color"
            ],
