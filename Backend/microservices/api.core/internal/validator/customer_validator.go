...
func (v *CustomerValidator) ValidateForCreation(req domain.CreateCustomerRequest) error {
...
func (v *CustomerValidator) ValidateForUpdate(id uint, req domain.UpdateCustomerRequest) error {
	var errors ValidationErrors
