...
func (v *SupplierValidator) ValidateForCreation(req domain.CreateSupplierRequest) error {
...
func (v *SupplierValidator) ValidateForUpdate(id uint, req domain.UpdateSupplierRequest) error {
	var errors ValidationErrors
