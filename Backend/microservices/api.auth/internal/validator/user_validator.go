...
func (v *UserValidator) ValidateForCreation(req domain.CreateUserRequest) error {
...
func (v *UserValidator) ValidateForUpdate(id uint, req domain.UpdateUserRequest) error {
	var errors ValidationErrors
...
func (v *UserValidator) ValidatePasswordChange(id uint, req domain.ChangePasswordRequest, isAdmin bool) error {
	var errors ValidationErrors
