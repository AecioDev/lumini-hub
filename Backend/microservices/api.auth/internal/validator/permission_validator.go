...
// PermissionValidator valida regras de negócio relacionadas a permissões
type PermissionValidator struct {
	roleRepo repository.RoleRepository
	permRepo repository.PermissionRepository
}

// NewPermissionValidator cria um novo validador de permissões
...
// ValidateForCreation valida os dados para criação de uma permissão
func (v *PermissionValidator) ValidateForCreation(req domain.InCreatePermission) error {
...
// ValidateForUpdate valida os dados para atualização de uma permissão
func (v *PermissionValidator) ValidateForUpdate(id uint, req domain.InUpdatePermission) error {
	var errors ValidationErrors
