...
func (v *RoleValidator) ValidateForCreation(req domain.CreateRoleRequest) error {
...
func (v *RoleValidator) ValidateForUpdate(id uint, req domain.UpdateRoleRequest) error {
	var errors ValidationErrors
