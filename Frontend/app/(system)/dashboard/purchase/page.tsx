...
export default function DashboardPage() {
  return (
    <PagePermissionGuard
      requiredPermissions={["dashboard.purchases.view"]}
      accessDeniedMessage="Você não tem permissão para visualizar este Dashboard."
    >
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Dashboard Compras</h1>
          <p className="text-muted-foreground">Visão geral de Compras</p>
        </div>
